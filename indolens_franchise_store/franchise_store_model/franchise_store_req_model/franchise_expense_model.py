...
class FranchiseExpenseModel:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'FranchiseExpenseModel':
        ...
        return FranchiseExpenseModel(store_expense_id, store_id, store_type, expense_amount, expense_reason, expense_date, created_on, created_by)
...
def franchise_expense_model_from_dict(s: Any) -> FranchiseExpenseModel:
    return FranchiseExpenseModel.from_dict(s)


def franchise_expense_model_to_dict(x: FranchiseExpenseModel) -> Any:
    return to_class(FranchiseExpenseModel, x)
