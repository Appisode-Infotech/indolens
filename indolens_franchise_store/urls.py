...
urlpatterns = [
    ...
    path('ready_in_lab_franchise_store_orders/', readyFranchiseOrders, name='ready_franchise_store_orders'),
    path('ready_in_franchise_store_orders/', storeDeliverdFranchiseOrders, name='store_delivered_franchise_store_orders'),
    ...
    path('franchise_stock_request_invoice/requestId=<int:requestId>', viewFranchiseStockRequestInvoice,
         name='franchise_stock_request_invoice'),
