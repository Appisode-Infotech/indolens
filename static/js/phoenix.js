                ...
                lists.forEach(el => {
                    ...
                    navLinks.forEach(function (link) {
                        link.addEventListener('click', function () {
                            ...
                            var wholeString = this.getAttribute('href').substring(8);
                            let splitArray = wholeString.split("-");
                            var filterLink = document.querySelector('.nav-link.filter[href="#filter-' + splitArray[0] + '-' + splitArray[1] + '"]');
                            if (filterLink) {
