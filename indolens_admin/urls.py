...
urlpatterns = [
    ...
    path('manage_central_inventory_category/enable_disable_product_category/?categoryId=<int:cid>/?status=<int:status>',
    ...
    path('manage_central_inventory_brands/enable_disable_product_brand/?brandsId=<int:bid>/?status=<int:status>',
    ...
    path('manage_central_inventory_shapes/enable_disable_frame_shape/?shapeId=<int:sid>/?status=<int:status>',
    ...
    path('manage_central_inventory_frame_types/enable_disable_frame_type/?typeId=<int:tid>/?status=<int:status>',
    ...
    path('manage_central_inventory_color/enable_disable_master_color/?colorId=<int:mcid>/?status=<int:status>',
    ...
    path('manage_central_inventory_materials/enable_disable_master_material/?materialId=<int:mid>/?status=<int:status>',
