...
class SalesExecutivesModel:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'SalesExecutivesModel':
        ...
        return SalesExecutivesModel(sales_executive_id, name, email, phone, password, profile_pic, assigned_store_id, address, document_1_type, document_1_url, document_2_type, document_2_url, status, created_by, created_on, last_updated_by, last_updated_on)
...
def sales_executives_model_from_dict(s: Any) -> SalesExecutivesModel:
    return SalesExecutivesModel.from_dict(s)


def sales_executives_model_to_dict(x: SalesExecutivesModel) -> Any:
    return to_class(SalesExecutivesModel, x)
