...
class MarketingHeadModel:
    ...
    def from_dict(obj: Any) -> 'MarketingHeadModel':
        ...
        return MarketingHeadModel(marketing_head_id, fullName, email, phone, password, profile_pic, assigned_area_head, completeAddress, document_1_type, document_1_url, document_2_type, document_2_url, status, created_by, created_on, last_updated_by, last_updated_on)
