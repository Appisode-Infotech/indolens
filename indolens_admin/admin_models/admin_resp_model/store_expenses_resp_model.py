...
class StoreExpense:
    def __init__(self, values):
        (
            self.store_expense_id, self.store_id, self.store_type,
            self.expense_amount, self.expense_reason, self.expense_date,
            self.created_on, self.created_by, self.creator_name
        ) = values
    ...
    def to_dict(self):
        return {
            ...
            'expense_date': self.expense_date.strftime('%d/%m/%Y %I:%M %p') if isinstance(self.expense_date, datetime) else None,
