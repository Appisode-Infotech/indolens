...
class InvoiceOrder:
    def __init__(self, values):
        (
            ...
            self.frame_type_name, self.shape_name, self.color_name, self.unit_name, self.brand_name,self.broken_gst,
            self.gst_exclusive_amt
        ) = values
    ...
    def to_dict(self):
        return {
            ...
            'broken_gst': self.broken_gst,
            'gst_exclusive_amt': self.gst_exclusive_amt,
        }


def get_order_invoice_detail(response):
    sales_order_list = []
    for values in response:
        sales_order = InvoiceOrder(values)
