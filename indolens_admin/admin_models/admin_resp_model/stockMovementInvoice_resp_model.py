...
class Product:
    def __init__(self, values):
        (
            ...
            self.unit_name, self.brand_name, self.store_name, self.store_email, self.store_phone, self.store_address,
            self.sender_store, self.billing_amount
...
def get_stock_movement_invoice(response):
    return Product(response).to_dict()
