...
class Product:
    def __init__(self, values):
        (
            ...
            self.hsn, self.power_attribute, self.franchise_sale_price, self.product_quantity, self.status, self.discount, self.product_gst, self.created_on,
    ...
    def to_dict(self):
        return {
            ...
            'store_product_created_on': self.store_product_created_on.strftime('%d/%m/%Y %I:%M %p') if isinstance(self.store_product_created_on, datetime) else None,
            'store_product_created_by': self.store_product_created_by,
            'store_product_last_updated_on': self.store_product_last_updated_on.strftime('%d/%m/%Y %I:%M %p') if isinstance(self.store_product_last_updated_on, datetime) else None,
