...
class Product:
    def __init__(self, values):
        (
            ...
            self.hsn, self.power_attribute, self.franchise_sale_price, self.product_quantity, self.product_gst, self.status, self.discount, self.created_on,
...
def get_products_for_stock_request(response):
    product_list = []
