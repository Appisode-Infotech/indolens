...
def get_all_store_expense(store_id, store_type):
    try:
        with getConnection().cursor() as cursor:
            get_expense_obj_query = f""" SELECT se.*, creator.ose_name AS creator_name FROM store_expense AS se
                                            LEFT JOIN own_store_employees AS creator ON se.se_created_by = creator.ose_employee_id
                ...
                if new_data.get('product_category_id') == '2':
                    ...
                    if discount_percentage == "" or is_discount_applied == 0 or None:
                        ...
                        data_to_insert = (
                            ...
                            billingDetailsData.get('orderByEmployee'), getIndianTime(),
                            1, billingDetailsData.get('saleNote'), json.dumps(linked_items), 1
                        )
                    ...
                    if discount_percentage == "" or is_discount_applied == 0 or None:
                        ...
                        data_to_insert = (
                            ...
                            store_id, billingDetailsData.get('orderByEmployee'), getIndianTime(),
                            billingDetailsData.get('orderByEmployee'), getIndianTime(),
                            1, billingDetailsData.get('saleNote'), 1
                        )
                    ...
                    data_to_insert = (
                        ...
                        getIndianTime(), json.dumps(power_attributes), 1,
